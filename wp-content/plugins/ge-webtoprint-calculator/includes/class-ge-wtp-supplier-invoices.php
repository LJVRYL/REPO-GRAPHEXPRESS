...
final class GE_WTP_Supplier_Invoices {
    ...
    public static function redaction_profile( $supplier ) { if ( 'mardones' !== $supplier ) { return array(); } return array( 'redactions' => array( array( .043, .033, .182, .086 ), array( .048, .132, .288, .012 ), array( .048, .155, .185, .010 ) ), 'protected' => array( array( .040, .120, .310, .012 ), array( .040, .145, .360, .009 ), array( .240, .151, .180, .014 ), array( .040, .166, .180, .012 ), array( .610, .100, .300, .090 ), array( .035, .190, .930, .790 ) ) ); }
